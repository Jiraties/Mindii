...
const Diagnosis = (props) => {
  ...
  const handleCustomOptionPress = (
    ...
    switch (latestSelectedSymptom.id) {
      ...
      case "vomit":
        // if (latest.question === "คุณอาเจียนมีเลือดหรืออาเจียนเป็นสีกาแฟไม่") {
        //   if (latest.value === "yes") {
        //     createYesNoOptions(
        //       "คุณมีไข้และมีจุดเเดงจํ้าเขียวหรือเลือดออกที่อื่น",
        //       true
        //     );
        //   } else {
        //     createYesNoOptions("คุณอาเจียนรุนแรงหรือไม่", true);
        //   }
        // }
        // if (latest.question === "คุณอาเจียนรุนแรงหรือไม่") {
        //   if (latest.value === "yes") {
        //     createYesNoOptions(
        //       "คุณพึ่งอาเจียนหลังจากฟื้นจากไข้หวัดหรือไม่",
        //       true
        //     );
        //   } else {
        //     createYesNoOptions(
        //       "ช่วงที่ผ่านมาคุณกินกินสัตว์ที่มีพิษหรือเสี่ยงมีพิษหรือไม่",
        //       true
        //     );
        //   }
        // }
        // if (latest.question === "คุณพึ่งอาเจียนหลังจากฟื้นจากไข้หวัดหรือไม่") {
        //   if (latest.value === "yes") {
        //     jumpToConclusions("reye_syndrome");
        //   } else {
        //     createYesNoOptions("คุณปวดท้องรุนเเรงหรือไม่", true);
        //   }
        // }
        // if (latest.question === "คุณปวดท้องรุนเเรงหรือไม่") {
        //   if (latest.value === "yes") {
        //     // jumpToConclusions("no_match");
        //   } else {
        //     createYesNoOptions(
        ...
        // if (
        //   latest.question ===
        //   "ช่วงที่ผ่านมาคุณกินสัตว์ที่มีพิษหรือเสี่ยงมีพิษหรือไม่"
        // ) {
        //   if (latest.value === "yes") {
        //     jumpToConclusions("botulism");
        //   } else {
        //     createYesNoOptions(
        //       "ช่วงที่ผ่านมาคุณกินอาหารทะเลหรืออาหารไม่สุขหรือไม่",
        //       true
        //     );
        //   }
        // }
        ...
        //   } else {
        //     createYesNoOptions("อาเจียนเฉพาะเวลาไอ", true);
        //   }
        // }
        // if (latest.question === "อาเจียนเฉพาะเวลาไอ") {
        //   if (latest.value === "yes") {
        //     jumpToConclusions("no_match");
        //   } else {
        //     createYesNoOptions("อาเจียนเฉพาะเวลาไอ", true);
        ...
        if (latest.question === "อาเจียนเป็นเลือดหรือเป็นสีกาแฟใช่หรือไม่") {
          if (latest.value === "yes") {
            createYesNoOptions(
              "คุณมีไข้มีจุดแดงจ้ำเขียวหรือเลือดออกที่อื่นใช่หรือไม่",
              true
            );
          } else {
            createYesNoOptions("คุณอาเจียนรุนแรงหรือไม่", true);
        ...
        if (
          ...
          if (latest.value === "yes") {
            createYesNoOptions(
              "หลังกินยาแก้ปวดหรือดื่มแอลกอฮอล์ใช่หรือไม่",
              true
            );
          } else {
            createYesNoOptions(
              "ตาเหลือง ท้องบวมหรือเป็นโรคตับแข็งใช่หรือไม่",
              true
            );
          }
        }
        if (latest.question === "หลังกินยาแก้ปวดหรือดื่มแอลกอฮอล์ใช่หรือไม่") {
          if (latest.value === "yes") {
            jumpToConclusions("acute_gastritis");
          } else {
            createYesNoOptions(
              "เคยมีอาการปวดท้องเรื้อรังหรือเป็นโรคกระเพาะมาก่อนใช่หรือไม่",
              true
            );
          }
        }
        if (
          latest.question === "ตาเหลือง ท้องบวมหรือเป็นโรคตับแข็งใช่หรือไม่"
        ) {
          if (latest.value === "yes") {
            jumpToConclusions("severe_cirrhosis");
          } else {
            createYesNoOptions(
              "เคยมีอาการปวดท้องเรื้อรังหรือเป็นโรคกระเพาะมาก่อนใช่หรือไม่",
              true
        ...
        if (
          ...
          if (latest.value === "yes") {
            createYesNoOptions("เบื่ออาหารและน้ำหนักลดใช่หรือไม่", true);
          } else {
            jumpToConclusions("peptic_ulcer");
          }
        }
        if (latest.question === "เบื่ออาหารและน้ำหนักลดใช่หรือไม่") {
          if (latest.value === "yes") {
            jumpToConclusions("stomach_cancer");
          } else {
            jumpToConclusions("peptic_ulcer");
          }
        }
        if (latest.question === "คุณอาเจียนรุนแรงหรือไม่") {
          if (latest.value === "yes") {
            createYesNoOptions(
              "คุณมีปวดศีรษะรุนแรง คอแข็ง หรือมีประวัติศีรษะได้รับบาดเจ็บภายใน 1 สัปดาห์ใช่หรือไม่",
              true
            );
          } else {
            createYesNoOptions(
              "คุณพึ่งอาเจียนหลังจากฟื้นจากไข้หวัดใช่หรือไม่",
              true
            );
          }
        }
        if (
          ...
          if (latest.value === "yes") {
            jumpToConclusions("possible_meningitis_or_brain_injury");
          } else {
            createYesNoOptions(
              "คุณพึ่งอาเจียนหลังจากฟื้นจากไข้หวัดใช่หรือไม่",
              true
        ...
        if (
          latest.question === "คุณพึ่งอาเจียนหลังจากฟื้นจากไข้หวัดใช่หรือไม่"
        ) {
          if (latest.value === "yes") {
            jumpToConclusions("reye_syndrome");
          } else {
